...
const build = gulp.series(clean, copy, sprite, gulp.parallel(compileMinStyles, compileScripts));
const dev = gulp.series(clean, copy, sprite, gulp.parallel(compileMinStyles, compileScripts, optimizePng, optimizeJpg, optimizeSvg), syncServer);
const start = gulp.series(clean, copy, sprite, gulp.parallel(compileStyles, compileScripts), syncServer);
const nomin = gulp.series(clean, copy, sprite, gulp.parallel(compileStyles, compileScripts, optimizePng, optimizeJpg, optimizeSvg));
